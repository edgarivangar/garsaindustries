        ...
        <div className="grid gap-12 lg:grid-cols-5 lg:gap-16">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground">
              Completa el formulario y nuestro equipo de ingeniería te enviará
              una cotización a la medida, con respuesta en el menor tiempo
              posible.
            </p>
              ...
              {submitted ? (
                <div className="flex min-h-[420px] flex-col items-center justify-center text-center">
                  ...
                  <p className="mt-2 max-w-sm text-muted-foreground">
                    Gracias por contactar a GARSA Industries. Un ingeniero
                    revisará tu requerimiento y te responderá a la brevedad.
                  </p>
                  <Button
                    variant="outline"
                    size="lg"
                ...
                <form onSubmit={handleSubmit} className="grid gap-5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      placeholder="Diámetro, presión, temperatura, tipo de fluido, material, cantidad..."
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="h-12 blue-gradient text-base text-white shadow-lg shadow-primary/20 hover:opacity-95"
                  >
                    Enviar solicitud
                  </Button>
                  <p className="text-center text-xs text-muted-foreground">
                    Al enviar aceptas ser contactado por el equipo de GARSA
                    Industries.
                  </p>
                </form>
              )}
